...
let cardData: [Card] = [
    Card(
        ...
        callToAction: "Design",
        message: "Introducing a modern way to design user interface for any Apple device",
        gradientColor: [Color("Color01"),Color("Color02")]
    ),
    Card(
      title: "iOS 14",
      ...
      gradientColor: [Color("Color03"), Color("Color04")]
    ),
    Card(
      title: "Swift 5",
      ...
      gradientColor: [Color("Color05"), Color("Color06")]
    ),
    Card(
      title: "Catalyst",
      ...
      gradientColor: [Color("Color07"), Color("Color08")]
    ),
    Card(
      title: "Playgrounds",
      ...
      gradientColor: [Color("Color09"), Color("Color10")]
    ),
    Card(
      title: "Xcode 12",
      ...
      gradientColor: [Color("Color11"), Color("Color12")]
    )
]
